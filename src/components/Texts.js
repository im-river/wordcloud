...
const databaseURL = "https://wordcloud-52be6.firebaseio.com/";
...
class Texts extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            fileName: '',       // 텍스트 파일 이름
            fileContent: null,  // 텍스트 파일 안의 문장들
            texts: {},          // 파이어베이스에서 받아오는 데이터셋
            textName: '',       // 각 텍스트에 대한 id(사용자가 직접 입력)
            dialog: false
        }
    }
    _get() {
    ...
    componentDidMount() { //모든 UI가 구성이 되었을 때 불러오기
        this._get();
    }
            ...
            <div>
                ...
                <Dialog open={this.state.dialog} onClose={this.handleDialogToggle}>
                    ...
                    <DialogActions>
                        ...
                        <Button variant="contained" color="primary" onClick={this.handleDialogToggle}>
                            닫기
                        </Button>
                    </DialogActions>
                </Dialog>
